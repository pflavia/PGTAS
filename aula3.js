...
console.log(`Lista de itens da sala:
    ${minhaSalaTem[0].id}º item ${minhaSalaTem[0].nome} que pesa ${minhaSalaTem[0].peso} e tem as cores ${minhaSalaTem[0].cores.join(", ")} 
    ${minhaSalaTem[1].id}º item ${minhaSalaTem[1].nome} que pesa ${minhaSalaTem[1].peso} e tem as cores ${minhaSalaTem[1].cores.join(", ")}
    ${minhaSalaTem[2].id}º item ${minhaSalaTem[2].nome} que pesa ${minhaSalaTem[2].peso} e tem as cores ${minhaSalaTem[2].cores.join(", ")}
    ${minhaSalaTem[3].id}º item ${minhaSalaTem[3].nome} que pesa ${minhaSalaTem[3].peso} e tem as cores ${minhaSalaTem[3].cores.join(", ")}
    `);